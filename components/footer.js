...
const Footer = () => {
    return (
        <div className="dark:bg-gray-900 py-16 xl:px-20 lg:px-12 sm:px-6 px-4">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                <div className="flex flex-col flex-shrink-0">
                    ...
                    <p className="text-sm leading-none text-gray-300 mt-4">Copyright © 2021 Luxe</p>
                ...
                <div className="sm:ml-0 ml-8">
                    <h2 className="text-base font-semibold leading-4 text-gray-300">Company</h2>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">Blog</p>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">Pricing</p>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">
                        About Us
                    </p>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">
                        Contact us
                ...
                <div>
                    <h2 className="text-base font-semibold leading-4 text-gray-300">Support</h2>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">
                        Legal policy
                    </p>
                    <p className="hover:text-gray-400 text-base leading-4 mt-6 text-gray-300 cursor-pointer">
                ...
                <div className="mt-10 lg:block hidden">
                    <label className="text-xl font-medium leading-5 text-gray-300">Get updates</label>
                    <div className="cursor-pointer flex items-center justify-between border border-gray-500 mt-4">
                        <input
                            type="text"
                            className="text-base leading-4 p-4 w-full focus:outline-none text-gray-400 placeholder-gray-500 dark:bg-gray-900"
                            placeholder="Enter your email"
                        />
                        <svg
                            className="mr-4 fill-current text-gray-300 hover:text-gray-400"
                            width="16"
                            height="17"
                            viewBox="0 0 16 17"
                            fill="none"
            ...
            <div className="mt-10 lg:hidden">
                ...
                <div className="flex items-center justify-between border border-gray-800 mt-4">
                    <input
                        type="text"
                        className="text-base leading-4 p-4 relative z-0 w-full focus:outline-none text-gray-400 placeholder-gray-50 dark:bg-gray-900"
                        placeholder="Enter your email"
                    />
