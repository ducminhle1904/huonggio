                                    ...
                                    >
                                        ...
                                        <div className="flex justify-between flex-col sm:flex-row w-full items-start space-y-8 sm:space-y-0 sm:space-x-8">
                                            <div className="relative w-full">
                                                <SelectControl name="city" selectProps={{ placeholder: "Select city" }}>
                                        ...
                                        <InputControl name="phone" label="Phone" type="tel" />
                                        <SubmitButton className="mt-8">Proceed to payment</SubmitButton>
                                    </Form>
                                </div>
